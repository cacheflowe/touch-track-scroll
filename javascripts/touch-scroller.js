...
tts.TouchScroller = function( scrollOuterEl, scrollInnerEl, options ) {
    ...
    var onMove = function( touchEvent ) {
        ...
        if( ( _orientation == tts.TouchScroller.VERTICAL && _dragLockAxis == tts.TouchScroller.VERTICAL ) || ( _orientation == tts.TouchScroller.HORIZONTAL && _dragLockAxis == tts.TouchScroller.HORIZONTAL ) ) {
